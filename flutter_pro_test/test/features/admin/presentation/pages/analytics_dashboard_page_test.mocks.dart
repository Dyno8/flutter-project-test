...
// in flutter_pro_test/test/features/admin/presentation/pages/analytics_dashboard_page_test.dart.
...
/// A class which mocks [UserBehaviorTrackingService].
///
/// See the documentation for Mockito's code generation for more information.
class MockUserBehaviorTrackingService extends _i1.Mock
  ...
  _i5.Future<void> trackClickPattern({
    ...
    Map<String, Object?>? metadata,
      ...
      (super.noSuchMethod(
            Invocation.method(#trackClickPattern, [], {
              #elementId: elementId,
              #screenName: screenName,
              #metadata: metadata,
            }),
  ...
  _i5.Future<void> trackSearchBehavior({
    ...
    String? selectedResult,
      ...
      (super.noSuchMethod(
            Invocation.method(#trackSearchBehavior, [], {
              #query: query,
  ...
  _i5.Future<void> trackUserErrorEncounter({
    ...
    Map<String, dynamic>? context,
      ...
      (super.noSuchMethod(
            Invocation.method(#trackUserErrorEncounter, [], {
              #errorType: errorType,
              #screenName: screenName,
              #userAction: userAction,
              #context: context,
  ...
  Map<String, dynamic> getBehaviorSummary() =>
      (super.noSuchMethod(
            Invocation.method(#getBehaviorSummary, []),
            returnValue: <String, dynamic>{},
          )
          as Map<String, dynamic>);

  @override
  void clearBehaviorData() => super.noSuchMethod(
    Invocation.method(#clearBehaviorData, []),
    returnValueForMissingStub: null,
  );
}
